...
if [[ "$1" == "--bootstrap" ]]; then
    ...
    python create_or_update_db.py data/nomina_itaipu_2023-09-03.csv
    ...
    python create_or_update_db.py data/nomina_itaipu_2023-05-08.csv
    ...
    python create_or_update_db.py data/nomina_itaipu_2023-05-16.csv

    python create_or_update_db.py data/nomina_itaipu_2023-12-16.csv
fi
